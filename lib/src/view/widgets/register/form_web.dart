              ...
              child: Form(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Container(
                      child: Text("Create account", textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleLarge),
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        if (_formKey.currentState?.validate() ?? false) {
                          bool status =
                              await _authService.signUpWithEmail(context, _usernameController.text, _passwordController.text);
                          if (status) {
                            Navigator.of(context).pushReplacementNamed(DashboardRoute().route);
                          }
                        }
